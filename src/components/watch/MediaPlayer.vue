...
<script>
import Vue from "vue";
import { MedialElementPlayer } from "mediaelement";
...
#playback-play.transport-button
{
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#5dcc94), color-stop(100%,#02cc67));
...
{
	white-space: nowrap;
	font-family: Oswald, 'Lucida Sans Unicode', 'Lucida Grande', Helvetica, Arial, sans-serif;
